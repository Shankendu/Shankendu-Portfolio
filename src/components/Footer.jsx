    ...
    <>
      ...
      >
        <div className="text-4xl sm:text-5xl md:text-[5rem] flex items-center pb-10 md:pb-16 mb-10 border-b dark:border-[#A3A3A3] border-[#F0F0F0]">
          <div className=" h-12 md:h-16 w-12 md:w-16 rounded-full dark:bg-[#EAEAEA] bg-[#333333] overflow-hidden mr-3">
            <img className="" src={pp} alt="profile picture" />
          </div>
          <h1>Let&apos;s Connect</h1>
        </div>
        ...
        <div className="flex flex-col justify-between h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center justify-start gap-10 mt-2 md:mt-10">
            <button className="group relative z-0 h-fit w-full md:w-fit py-8 px-10 shadow-xl group-hover:shadow-2xl flex items-center justify-center overflow-hidden overflow-x-hidden rounded-full border group-hover:border-0 dark:border-[#EAEAEA] border-[#333333]  dark:text-[#eaeaea] text-[#333333]">
              <a className="relative z-10" href="mailto:shankenduk@gmail">shankenduk@gmail.com</a>
            ...
            <button className="group relative z-0 h-fit w-full md:w-fit py-8 px-10 shadow-xl group-hover:shadow-2xl flex items-center justify-center overflow-hidden overflow-x-hidden rounded-full border group-hover:border-0 dark:border-[#EAEAEA] border-[#333333]  dark:text-[#EAEAEA] text-[#333333]">
              <a className="relative z-10" href="tel:+918828198696">+91 8828198696</a>
              <span className="absolute inset-0 overflow-hidden rounded-md">
                <span className="absolute left-0 aspect-square w-full origin-center translate-x-full rounded-full bg-[#5B84FF] transition-all duration-500 group-hover:-translate-x-0 group-hover:scale-150"></span>
              </span>
            </button>

            <button className="group relative z-0 h-fit w-full md:hidden py-8 px-10 shadow-xl group-hover:shadow-2xl flex items-center justify-center overflow-hidden overflow-x-hidden rounded-full dark:bg-[#5B84FF] bg-[#5B84FF]  dark:text-[#eaeaea] text-[#333333]">
          ...
          <button className="group absolute right-[50%] top-[50%] translate-x-1/2 -translate-y-1/2 md:right-20 md:-top-5 z-0 h-44 sm:h-56 w-44 sm:w-56 shadow-xl group-hover:shadow-2xl flex items-center justify-center overflow-hidden overflow-x-hidden rounded-full dark:bg-[#5B84FF] bg-[#5B84FF]  dark:text-[#eaeaea] text-[#333333]">
            <span className="relative z-10">Get in Touch</span>
            <span className="absolute inset-0 overflow-hidden rounded-md">
              <span className="absolute left-0 aspect-square w-full origin-center translate-x-full rounded-full bg-[#4A73D1] transition-all duration-500 group-hover:-translate-x-0 group-hover:scale-150"></span>
            </span>
          ...
          <div className="flex flex-col-reverse md:flex-row items-start justify-between pb-5 gap-y-10">
            <div className="flex items-center gap-10">
              <section>
                ...
                <p className="text-sm md:text-base">&copy; {new Date().getFullYear()} Shankendu Kunti</p>
              </section>
              <section>
                <h1 className="text-start text-xs text-[#a3a3a3] pb-5">
                  LOCAL TIME
                </h1>
                <p className="text-sm md:text-base">{time.toLocaleTimeString()}</p>
              </section>
            </div>
