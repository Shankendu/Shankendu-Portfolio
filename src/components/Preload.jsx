...
const Preload = (props) => {
  return (
    <>
      <div id={`${props.id}`} className={`w-full h-screen flex items-center justify-center font-poppins font-black dark:bg-[#1a1a1a] dark:text-[#eaeaea] bg-[#F0F0F0] text-[#333333] text-5xl border-b-2 dark:border-[#A3A3A3] border-[#F0F0F0] ${props.className}`}>
